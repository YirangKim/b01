...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    @Override
    public Page<BoardListsReplyCountDTO> searchWithReplyCount(String[] types, String keyword, Pageable pageable) {
        ...
        List<BoardListsReplyCountDTO> dtoList = dtoQuery.fetch();
